...
(deftest keyword-test
  ...
  (is (thrown? #?(:clj clojure.lang.ExceptionInfo
                  :cljs js/Error) (evaluate (str '(:foo nil)))))
  (is (thrown? #?(:clj clojure.lang.ExceptionInfo
                  :cljs js/Error) (evaluate (str '(:foo ((1))))))))
...
(deftest implicit-list-test
  ...
  (is (= '()                      (evaluate (str '()))))
  (is (thrown? #?(:clj clojure.lang.ExceptionInfo
                  :cljs js/Error) (evaluate (str '(())))))
  (is (thrown? #?(:clj clojure.lang.ExceptionInfo
                  :cljs js/Error) (evaluate (str '(1 2 (3 4) 5))))))

(deftest value-test
  (is (thrown? #?(:clj clojure.lang.ExceptionInfo
                  :cljs js/Error) (evaluate (str 5))))
  (is (thrown? #?(:clj clojure.lang.ExceptionInfo
                  :cljs js/Error) (evaluate "nil")))
  (is (= 5                        (#'pl/pl-eval 5 {})))
  ...
  (is (thrown? #?(:clj clojure.lang.ExceptionInfo
                  :cljs js/Error) (doall (#'pl/pl-eval ''q-symbol std/fns))))
  (is (thrown? #?(:clj clojure.lang.ExceptionInfo
                  :cljs js/Error) (#'pl/pl-eval 'unq-symbol {})))
  (is (= 42                       (#'pl/pl-eval '$ {'$ 42}))))
...
(deftest list-test
  ...
  (is (thrown? #?(:clj clojure.lang.ExceptionInfo
                  :cljs js/Error) (evaluate (str '(list ())))))
  (is (thrown? #?(:clj clojure.lang.ExceptionInfo
                  :cljs js/Error) (evaluate (str '(1 2 (3 4) 5))))))
...
(deftest if-test
  ...
  (is (thrown? #?(:clj clojure.lang.ExceptionInfo
                  :cljs js/Error) (evaluate (str '(if (= 5 5)
                                                    "success"))))))
...
(deftest =-test
  ...
  #?(:clj (is (thrown? clojure.lang.ExceptionInfo
               (evaluate (str '(= 2.0 2))))))
  #?(:cljs (is (= true
               (evaluate (str '(= 2.0 2))))))
  (is (thrown? #?(:clj clojure.lang.ExceptionInfo :cljs js/Error)
               (evaluate (str '(= "red" ("red" "green"))))))
  (is (thrown? #?(:clj clojure.lang.ExceptionInfo :cljs js/Error)
               (evaluate (str '(= "red" (1) {:x 1})))))
  (is (thrown? #?(:clj clojure.lang.ExceptionInfo :cljs js/Error)
               (evaluate (str '(= "red" ((1)))))))
  (is (thrown? #?(:clj clojure.lang.ExceptionInfo :cljs js/Error)
               (evaluate (str '(= "red")))))
...
(deftest not=-test
  ...
  (is (thrown? #?(:clj clojure.lang.ExceptionInfo :cljs js/Error)
               (evaluate (str '(not= "red" ("red" "green"))))))
  (is (thrown? #?(:clj clojure.lang.ExceptionInfo :cljs js/Error)
               (evaluate (str '(not= "red" (1) {:x 1})))))
  (is (thrown? #?(:clj clojure.lang.ExceptionInfo :cljs js/Error)
               (evaluate (str '(not= "red" ((1)))))))
  (is (thrown? #?(:clj clojure.lang.ExceptionInfo :cljs js/Error)
               (evaluate (str '(not= "red" ((1)))))))
  (is (thrown? #?(:clj clojure.lang.ExceptionInfo :cljs js/Error)
               (evaluate (str '(not= "red")))))
  (is (thrown? #?(:clj clojure.lang.ExceptionInfo :cljs js/Error)
               (evaluate (str '(not= "red" ()))))))
...
(deftest sum-test
  ...
  (is (thrown? #?(:clj clojure.lang.ExceptionInfo :cljs js/Error)
               (evaluate (str '(sum {:x 1} {:y 2})))))
  (is (thrown? #?(:clj clojure.lang.ExceptionInfo :cljs js/Error)
               (evaluate (str '(sum 2 "1")))))
  #?(:clj (is (thrown? clojure.lang.ExceptionInfo
               (evaluate (str '(sum 1 2.0))))))
  #?(:cljs (is (= 3
               (evaluate (str '(sum 1 2.0))))))
  (is (thrown? #?(:clj clojure.lang.ExceptionInfo :cljs js/Error)
               (evaluate (str '(sum 2 (2 nil)))))))
...
(deftest product-test
  ...
  (is (thrown? #?(:clj clojure.lang.ExceptionInfo :cljs js/Error)
               (evaluate (str '(product ("x") "y" ("z"))))))
  (is (thrown? #?(:clj clojure.lang.ExceptionInfo :cljs js/Error)
               (evaluate (str '(product {:x 1} {:y 2})))))
  (is (thrown? #?(:clj clojure.lang.ExceptionInfo :cljs js/Error)
               (evaluate (str '(product 2 "1")))))
  #?(:clj (is (thrown? clojure.lang.ExceptionInfo
               (evaluate (str '(product 1 2.0))))))
  #?(:cljs (is (= 2
               (evaluate (str '(product 1 2.0))))))
  (is (thrown? #?(:clj clojure.lang.ExceptionInfo :cljs js/Error)
               (evaluate (str '(product 2 (2 nil)))))))
...
(deftest user-fn-test
  ...
  #?(:clj (is (thrown? Exception  (evaluate (str '(user/fn4))
                                            {'user/fn4 (fn [a b] (* a b))}))))
  #?(:cljs (is (= true            (.isNaN js/Number (evaluate (str '(user/fn4))
                                                              {'user/fn4 (fn [a b] (* a b))})))))
  (is (thrown? #?(:clj clojure.lang.ExceptionInfo
                  :cljs js/Error) (evaluate (str '(user/fn5))))))
